...
export const AddGameModal = ({ open, setOpen }) => {
    ...
    return (
        <Modal show={open} onClose={() => setOpen(false)} size={"xl"} dismissible>
            <Modal.Body className='bg-slate-500 rounded'>
                <div className='flex justify-center flex-col items-center'>
                    ...
                    <div className=" flex flex-col gap-5">
                        <form onSubmit={handleSubmit(submitData)} className=' m-auto flex flex-col items-center'>
                            ...
                            <input type="file" className='bg-gray-200 rounded mb-5 md:w-80'
                            ...
                            <input type="text" placeholder='Title' className='bg-gray-200 rounded mb-5 md:w-80'
                            ...
                            <input type="text" placeholder='Categorie' className='bg-gray-200 rounded mb-5 md:w-80'
